...
@section('content')
    <div class="dahboardMain">
        <div class="row g-0">
            ...
            <!-- tab1 -->
            @include("adminupdate.playerupdate.tab1")

            <!-- tab2 -->
            @include("adminupdate.playerupdate.tab2")

            <!-- tab3 -->
            @include("adminupdate.playerupdate.tab3")
            <!-- tab4 -->
            @include("adminupdate.playerupdate.tab4")

            <!-- tab5 -->
            @include("adminupdate.playerupdate.tab5")
            <!-- tab6 -->
            @include("adminupdate.playerupdate.tab6")

            <!-- tab7 -->
            @include("adminupdate.playerupdate.tab7")

            <!-- tab8 -->
            @include("adminupdate.playerupdate.tab8")

            <!-- tab9 -->
            {{-- @include("adminupdate.playerupdate.tab9") --}}
            {{-- notifaction tab --}}
            {{-- @include("adminupdate.playerupdate.tab15") --}}


            <!-- tab 12 -->
            {{-- @include("adminupdate.playerupdate.tab12") --}}

            <!-- tab910 -->
            {{-- @include("adminupdate.playerupdate.tab10") --}}

            <!-- tab11 -->
            @include("adminupdate.playerupdate.tab11")

            <!-- tab13 -->
            {{-- @include("adminupdate.playerupdate.tab13") --}}

            {{-- ScholarshipOffers --}}
            @include("adminupdate.playerupdate.tab14")
