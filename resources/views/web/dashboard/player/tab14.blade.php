            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 d-flex flex-column mt2 pNone">
                        ...
                        --}}
                        <input list="fbs-division" name="fbs__division" value="" placeholder="FBS Division 1 college">
                    ...
                    <div class="col-lg-6 d-flex flex-column mt2 pNone">
                        ...
                        <input list="fcs-division" name="fcs_division" value=""
                    ...
                    <div class="col-lg-6 d-flex flex-column mt2">
                        ...
                        {{-- <input type="text" value="{{@$basicInfo->secondry_defensive}}" name="secondry_defensive">
                        --}}
                        <input list="walk-on-committment" name="walk_on_committment" value=""
