              ...
              <table id="example1" class="table table-bordered table-striped dataTable dtr-inline " role="grid" aria-describedby="example1_info">
                ...
                <tbody>
                  ...
                  <tr role="row" class="odd">
                    ...
                    <td width="100">
                      <!-- Detail -->
                      <a href="#" class="viewContactButton" data-id="{{$value->id}}" data-route="{{route('subscription.show',$value->id)}}">
      ...
      <script>
        $(document).ready(function(){
          ...
          function fetch_user(id){
            $.ajax({
              url: '<?php echo(route("subscription.show", 0)); ?>',
              type: 'GET',
              data: {id: id},
              dataType: 'JSON',
              async: false,
              success: function (data) {
                contact_view = data.subscription_view;
              }
            });
          }
           //*** View Profile ***//
